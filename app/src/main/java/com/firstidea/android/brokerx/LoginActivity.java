...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            UserService userService= SingletonRestClient.createService(UserService.class, this);
            userService.appLogin(email, password, new Callback<MessageDTO>() {
                @Override
    ...
    private void showProgress(final boolean show) {
        if(show) {
            mDialog = AppProgressDialog.show(this);
        } else {
            mDialog.dismiss();
        }
    }
