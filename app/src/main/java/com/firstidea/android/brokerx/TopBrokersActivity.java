...
public class TopBrokersActivity extends AppCompatActivity implements TopBrokerAdapter.OnCardListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TopBrokerAdapter mAdapter = new TopBrokerAdapter(this,mList, this);
